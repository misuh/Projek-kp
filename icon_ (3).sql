...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Jun 2020 pada 01.29
...
(8, 'PLN UNIT INDUK DISTRIBUSI JAWA BARAT', '[UID JABAR - UP2D] BASECAMP GRUP HAR CIREBON', ' IPVPN ', 0, 1000056487, 'JABAR 1', '', 0, '00:00:00', '99.00', '100.00', 1),
...
INSERT INTO `usr` (`id`, `name`, `email`, `image`, `password`, `roles`, `ia`, `date_create`) VALUES
(1, 'momo', 'momo@gm.co', 'default.png', '$2y$10$4N24Lecoddum4Mdpff0kF.S6RdojX/MebmFtLAcsbUMqxwFXRtKHu', 2, 1, 1592186187);
...
INSERT INTO `usr_role` (`id`, `role`) VALUES
(1, 'admin'),
(2, 'user');
